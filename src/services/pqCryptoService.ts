 ...
 * now lives in the audited `@dis/shield` package and is exercised by DIS's
 ...
 * for vault item payloads. Do NOT add crypto here — add it to @dis/shield.
 *
 * @see https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.203.pdf
 * @see https://github.com/einmalmaik/dis
 */

export * from '@dis/shield/post-quantum';
