 ...
 * data formats — now lives in the audited `@dis/shield` package and is exercised
 ...
 * stored on the server. Do NOT add crypto here — add it to @dis/shield and
 * re-export it through this adapter.
 *
 * @see https://github.com/einmalmaik/dis
 */

export * from '@dis/shield/vault-crypto';
