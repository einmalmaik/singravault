...
const BRAND_ICON_BASE_REGISTRY: Record<string, BrandIconBaseDefinition> = {
  ...
  pornhub: brand('pornhub', 'Pornhub', '#f90', Video, null),
  xvideos: brand('xvideos', 'XVideos', '#e11d48', Video, null),
  xnxx: brand('xnxx', 'XNXX', '#2563eb', Video, null),
  onlyfans: brand('onlyfans', 'OnlyFans', '#00aeef', Users, null),
  chaturbate: brand('chaturbate', 'Chaturbate', '#f9a825', Video, null),
