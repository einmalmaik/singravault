...
const PROVIDER_MATCHERS: ProviderMatcher[] = [
  ...
  { id: 'gog', keywords: ['gog', 'gog.com'], hostnames: ['gog.com'] },
  { id: 'tinder', keywords: ['tinder'], hostnames: ['tinder.com'] },
  { id: 'pornhub', keywords: ['pornhub', 'porn hub'], hostnames: ['pornhub.com'] },
  { id: 'xvideos', keywords: ['xvideos', 'x videos'], hostnames: ['xvideos.com'] },
  { id: 'xnxx', keywords: ['xnxx'], hostnames: ['xnxx.com'] },
  { id: 'onlyfans', keywords: ['onlyfans', 'only fans'], hostnames: ['onlyfans.com'] },
  { id: 'chaturbate', keywords: ['chaturbate'], hostnames: ['chaturbate.com'] },
  { id: 'riotgames', keywords: ['riot', 'riot games', 'riotgames'], hostnames: ['riotgames.com'] },
  { id: 'leagueoflegends', keywords: ['league of legends', 'lol account'], hostnames: ['leagueoflegends.com'] },
  { id: 'valorant', keywords: ['valorant'], hostnames: ['playvalorant.com'] },
  { id: 'battlenet', keywords: ['battle.net', 'battlenet', 'blizzard'], hostnames: ['battle.net', 'blizzard.com'] },
  { id: 'ubisoft', keywords: ['ubisoft'], hostnames: ['ubisoft.com'] },
  { id: 'rockstargames', keywords: ['rockstar games', 'rockstar'], hostnames: ['rockstargames.com'] },
  { id: 'itchio', keywords: ['itch.io', 'itchio'], hostnames: ['itch.io'] },
  ...
  { id: 'ea', keywords: ['ea app', 'electronic arts', 'ea account'], hostnames: ['ea.com'] },
  ...
  { id: 'jetbrains', keywords: ['jetbrains'], hostnames: ['jetbrains.com'] },
  { id: 'intellijidea', keywords: ['intellij', 'intellij idea'] },
  { id: 'pycharm', keywords: ['pycharm'] },
  { id: 'webstorm', keywords: ['webstorm'] },
  { id: 'postman', keywords: ['postman'], hostnames: ['postman.com'] },
  { id: 'insomnia', keywords: ['insomnia'], hostnames: ['insomnia.rest'] },
  { id: 'notepadplusplus', keywords: ['notepad++', 'notepad plus plus'], hostnames: ['notepad-plus-plus.org'] },
  { id: 'obsidian', keywords: ['obsidian'], hostnames: ['obsidian.md'] },
  { id: 'obsstudio', keywords: ['obs studio', 'obs'], hostnames: ['obsproject.com'] },
  { id: 'blender', keywords: ['blender'], hostnames: ['blender.org'] },
  { id: 'autocad', keywords: ['autocad'], hostnames: ['autodesk.com'] },
  { id: 'unity', keywords: ['unity'], hostnames: ['unity.com'] },
  { id: 'unrealengine', keywords: ['unreal engine', 'unreal'], hostnames: ['unrealengine.com'] },
  { id: 'godot', keywords: ['godot', 'godot engine'], hostnames: ['godotengine.org'] },
  ...
  { id: 'hbo', keywords: ['hbo'], hostnames: ['hbo.com'] },
  { id: 'hbomax', keywords: ['hbo max', 'max.com'], hostnames: ['max.com', 'hbomax.com'] },
  { id: 'audible', keywords: ['audible'], hostnames: ['audible.com', 'audible.de'] },
  { id: 'goodreads', keywords: ['goodreads'], hostnames: ['goodreads.com'] },
  ...
  { id: 'klarna', keywords: ['klarna'], hostnames: ['klarna.com'] },
  { id: 'shopware', keywords: ['shopware'], hostnames: ['shopware.com'] },
  { id: 'etsy', keywords: ['etsy'], hostnames: ['etsy.com'] },
  { id: 'zalando', keywords: ['zalando'], hostnames: ['zalando.com', 'zalando.de'] },
];
